...
function PaintCard(paint) {
  ...
  return (
    <div className="flex flex-col justify-between gap-2 max-w-xs w-1/5 h-96 border-2 border-black py-4 px-3 rounded bg-offwhite hover:shadow-xl hover:shadow-golden/70 font-sans">
